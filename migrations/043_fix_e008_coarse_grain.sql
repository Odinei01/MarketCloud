-- Fix E008 — coarsening do grao: remove targeting/match_type/customer_search_term
-- (grao ultra-fino de 7 dims que o AMC suprime ~50%). Vira (data,campanha,apt,
-- tracked_asin) com sentinelas — captura as conversoes NTB/halo suprimidas no
-- grao fino. Mesmo padrao do E005. Marker E008_COARSE_GRAIN.
UPDATE query_templates
SET updated_at = NOW(),
    description = COALESCE(description,'') || ' [coarse grain E008_COARSE_GRAIN]',
